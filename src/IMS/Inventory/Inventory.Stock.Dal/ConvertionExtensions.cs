...
namespace Inventory.Stock.Dal
{
    public static class ConvertionExtensions
    {
        ...
        public static async Task<List<TDomain>> ToDomainOrNull<TDal, TDomain>(
        ...
        public static List<TDomain> ToDomainOrNull<TDal, TDomain>(this ICollection<TDal> list, Func<TDal, TDomain> domainConverter)
            where TDomain : class
        {
            if (list == null)
        ...
        public static List<TDal> ToDalOrNull<TDomain, TDal>(this ICollection<TDomain> list, Func<TDomain, TDal> dalConverter)
            where TDal : class
